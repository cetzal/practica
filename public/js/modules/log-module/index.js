...
/***/ "./resources/js/modules/log-module/index.js":
/*!**************************************************!*\
  !*** ./resources/js/modules/log-module/index.js ***!
  \**************************************************/
      ...
      if (previous_value != null) {
        ...
        for (var index = 0; index < keys_previous.length; index++) {
          if (_typeof(previous_value[keys_previous[index]]) != undefined) {
            tr += '<tr><td><b>' + keys_previous[index] + '</b></td><td>' + previous_value[keys_previous[index]] + '</td>' + '<td>' + current_value[keys_previous[index]] + '</td></tr>';
          }
        }
      } else {
        var _html = '<table>' + '<thead><tr><th></th><th>Current</th></tr></thead>';
        var keys_current = Object.keys(current_value);
        for (var _index = 0; _index < keys_current.length; _index++) {
          if (_typeof(current_value[keys_current[_index]]) != undefined) {
            tr += '<tr><td><b>' + keys_current[_index] + '</b></td>' + '<td>' + current_value[keys_current[_index]] + '</td></tr>';
          }
        }
      }
      tr += '</tbody>';
...
/***/ 12:
/*!********************************************************!*\
  !*** multi ./resources/js/modules/log-module/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /usr/local/var/www/practica/resources/js/modules/log-module/index.js */"./resources/js/modules/log-module/index.js");
