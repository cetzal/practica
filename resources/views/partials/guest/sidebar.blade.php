...
<div class="side-bar active">
    ...
    <div class="item"><a href="{{route('purchase-details.index')}}"><i class="fas fa-desktop"></i>Detalle de compra</a></div>
    <div class="item"><a href="{{route('sales.index')}}"><i class="fas fa-desktop"></i>{{ trans('file.sale') }}</a></div>
    <div class="item"><a href="{{route('sale-details.index')}}"><i class="fas fa-desktop"></i>Detalle de venta</a></div>
