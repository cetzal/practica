...
<section>
    <div class="container-fluid mb-2 p-1">
        <h4>{{trans('file.Payment list')}}</h4>
    </div>
    <div class="container-fluid mb-2 p-1">
        <a href="{{ route('payments.create') }}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Payment')}}</a>
...
@endsection
@section('scripts')
    <script src="{{ asset('js/modules/payments/index.js') }}"></script>
@endsection